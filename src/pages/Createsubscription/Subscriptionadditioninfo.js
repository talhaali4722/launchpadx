...
function Subscriptionadditioninfo() {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const setDescription = useSubscriptionAdditionalInfo(
  ...
  const takeBack = (e) => {
    e.preventDefault();
    e.returnValue = "";
    navigate("/Createsubscription/Subscriptionpool");
  };

  const onSubmit = (e) => {
    navigate("/Createsubscription/Finishsubscription");
  };
              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <ul style={{ maxWidth: "1400px" }} className="verify-list">
                  ...
                  <li className="active complete">
                    <span>02</span>
                    <div className="txt-pnl">
                      <h6>Subscription Launchpad Info</h6>
                      <p>
                        Enter the Subscription information that you want to
...
export default Subscriptionadditioninfo;
