...
function Addaditionalinfo() {
  ...
  const setLogoUrl = useAddtionalInfoStore((state) => state.setLogoUrl);
  const webUrl = useAddtionalInfoStore((state) => state.webUrl);
  const setWebUrl = useAddtionalInfoStore((state) => state.setWebUrl);
  const facebookUrl = useAddtionalInfoStore((state) => state.facebookUrl);
  const setFacebookUrl = useAddtionalInfoStore((state) => state.setFacebookUrl);
  const twitterUrl = useAddtionalInfoStore((state) => state.twitterUrl);
  const setTwitterUrl = useAddtionalInfoStore((state) => state.setTwitterUrl);
  const instagramUrl = useAddtionalInfoStore((state) => state.instagramUrl);
  const setInstagramUrl = useAddtionalInfoStore(
    (state) => state.setInstagramUrl
  );
  const discordUrl = useAddtionalInfoStore((state) => state.discordUrl);
  const setDiscordUrl = useAddtionalInfoStore((state) => state.setDiscordUrl);
  const redditUrl = useAddtionalInfoStore((state) => state.redditUrl);
  const setRedditUrl = useAddtionalInfoStore((state) => state.setRedditUrl);
  const gitHubUrl = useAddtionalInfoStore((state) => state.gitHubUrl);
  const setGithubUrl = useAddtionalInfoStore((state) => state.setGithubUrl);
  const telegramUrl = useAddtionalInfoStore((state) => state.telegramUrl);
  const setTelegramUrl = useAddtionalInfoStore((state) => state.setTelegramUrl);

  const description = useAddtionalInfoStore((state) => state.description);
  const setDescription = useAddtionalInfoStore((state) => state.setDescription);
  ...
  const onSubmit = (e) => {
    navigate("/Createlaunchpad/Finishlaunchpad");
  };
